        ...
        builder: (context, state) {
          return WillPopScope(
            ...
            child: Scaffold(
              ...
              body: SafeArea(
                child: Padding(
                  padding: EdgeInsets.all(AppTheme.of(context).screenMarging),
                  child:
                      state is QuoteDetailsSuccess
...
class _Quote extends StatelessWidget {
  ...
  const _Quote({required this.quote, Key? key});
    ...
    return Column(
      ...
      children: [
        const Align(
          ...
          child: OpeningQuotesScvgAsset(width: _quoteIconWidth),
        ),
        Expanded(
          child: Padding(
