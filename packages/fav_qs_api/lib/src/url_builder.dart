class UrlBuilder {
  ...
  String buildGetQuoteListPageUrl(
    ...
    assert(
      ...
      "FavQs doesn't support filtering favorites or searching by both query and tag at the same time",
    );

    final tagQueryStringPart = tag != null ? '&filter=$tag&type=tag' : '';
    final favoriteQueryStringPart =
  ...
  String buildGetQuoteUrl(int id) => '$_baseUrl/quotes/$id';
